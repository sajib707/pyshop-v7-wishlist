...
def account_register(request):
    ...
    if request.method == 'POST':
        ...
        if registerForm.is_valid():
            ...
            message = render_to_string('account/login_registration/account_activation_email.html', {
                'user': user,
    ...
    return render(request, 'account/login_registration/register.html', {'form': registerForm})
...
def account_activate(request, uidb64, token):
    ...
    if user is not None and account_activation_token.check_token(user, token):
        ...
        return render(request, 'account/login_registration/activation_invalid.html')
